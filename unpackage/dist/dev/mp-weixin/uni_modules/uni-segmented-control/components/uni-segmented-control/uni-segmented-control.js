  ...
  return {
    a: common_vendor.f($props.values, (item, index, i0) => {
      return {
        ...
        j: common_vendor.o(($event) => $options._onClick(index))
      };
    }),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/huachen/Projects/mianbi/mianbi-mp/uni_modules/uni-segmented-control/components/uni-segmented-control/uni-segmented-control.vue"]]);
